...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  OperationId: 'registry-minted execution-attempt correlation is owned by packages/core/session/README.md',
  ToolPolicy: 'mandatory security recommendation type is owned by packages/core/tools/README.md',
  ToolExecutionIdentity: 'registry-owned frozen execution identity record is owned by packages/core/tools/README.md',
  SessionIntegrity: 'durable completeness provenance is owned by packages/session/session-persistence/README.md',
