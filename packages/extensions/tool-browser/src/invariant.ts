...
/**
 * No runtime invariant: the per-session page lifecycle and its closure
 * guarantee are exercised by the package's own browser tests, not an
 * event-stream relation another companion could observe.
 */
