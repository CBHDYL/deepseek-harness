...
Harness remediation 计划的已确认需求。权威执行状态见 [REMEDIATION-IMPLEMENTATION.md](../REMEDIATION-IMPLEMENTATION.md)；规范设计为 `docs/system-wide-audit.md` 中的 Remediation Plan Design Review（见其 [中文对侧](system-wide-audit.zh.md)）。
