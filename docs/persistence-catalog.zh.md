...
来源：[`packages/core/session/src/types.ts:383`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:390`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:420`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:452`](../packages/core/session/src/types.ts)

## 事件

### `action-policy/*`

<a id="actionpolicycandidate--log-only"></a>
...
来源：[`packages/guard/action-policy-guard/src/types.ts:25`](../packages/guard/action-policy-guard/src/types.ts)
...
来源：[`packages/core/tools/src/types.ts:52`](../packages/core/tools/src/types.ts)
